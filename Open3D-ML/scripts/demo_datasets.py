...
def parse_args():
    ...
    parser.add_argument('--path_scannet', default='/media/vcg8004/WD_BLACK/dataset/scannetv2_processed', help='path to S3DIS')
...
def demo_dataset(args):
    ...
    if args.path_scannet is not None:
        datasets.append(Scannet(dataset_path=args.path_scannet, use_cache=False))
