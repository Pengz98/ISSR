...
def parse_args():
    ...
    parser.add_argument('--dataset_path',
                        ...
                        default='/media/vcg8004/WD_BLACK/dataset/Semantic3D',
                        required=False)
    parser.add_argument('--out_path', help='Output path', default='/media/vcg8004/WD_BLACK/dataset/Semantic3D_processed')
